                        ...
                        <form @submit.prevent="createUser">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label class="col-form-label">User Number</label>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input v-model="form.group" type="text" name="group" placeholder="Group"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label class="col-form-label">Phone Login</label>
                                    <input type="text" class="form-control">
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="col-form-label">Phone Password</label>
                                    <input type="text" class="form-control">
                                </div>
